...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Dashboard / Tugas Akhir / Tambah Tugas Akhir</h1>
    </div>
    <!-- Content Row -->
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="judul_skripsi" type="text" placeholder="Judul Tugas Akhir" name="judul_skripsi" value="{{ old('judul_skripsi') }}" required>
                        </div>

                        <div class="mb-3">
                            <label class="text-danger">*</label>
                            <label for="tahun">Tahun</label>
                            <input class="form-control" id="tahun" type="text" placeholder="Tahun Tugas Akhir" name="tahun" value="{{ old('tahun') }}" required>
                        </div>

                        <div class="mb-3">
                            <label class="text-danger">*</label>
                            <label for="kode_skripsi">Kode TA</label>
                            <input class="form-control" id="kode_skripsi" type="text" placeholder="Kode Tugas Akhir" name="kode_skripsi" value="{{ old('kode_skripsi') }}" required>
                        </div>
                        <div class="mb-3">
                            <label class="text-danger">*</label>
